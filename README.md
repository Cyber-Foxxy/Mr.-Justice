...
**The Lantern Path** is a small interactive artwork created for a final web project. The user controls Mr. Justice, a silver lantern-headed traveler, as he explores a magical twilight landscape. His lantern reveals hidden runes, glowing sparks, floating islands, and a sky portal.

## How to Play / Interact

- Use **WASD** or the **Arrow Keys** to move.
- Walk near hidden runes to reveal them.
- Touch revealed runes to collect light.
- Click on the canvas to create small spark effects.
- Collect every rune to awaken the sky portal.
